...
_DEFAULT_SQL_CONNECTION = 'sqlite:///' + paths.state_path_def('soil.sqlite')
_ENRICHED = False
...
This group should **not** be configured for the ``soil-api`` service.
""")
...
api_db_opts = [
    ...
    cfg.StrOpt('connection',
        ...
        help='Do not set this for the ``soil`` service.'),
