...
ALL_OPTS = [
    cfg.StrOpt('pybasedir',
        ...
        sample_default='<Path>',
        help="""
The directory where the Soil python modules are installed.
...
need to persist Soil internal data. It is very unlikely that you need to
...
"""),
    cfg.StrOpt('bindir',
        ...
        help="""
The directory where the Soil binaries are installed.

This option is only relevant if the networking capabilities from Soil are
used (see services below). Soil's networking capabilities are targeted to
...
"""),
    cfg.StrOpt('state_path',
        default='$pybasedir',
        help="""
The top-level directory for maintaining Soil's state.

This directory is used to store Soil's internal state. It is used by a
